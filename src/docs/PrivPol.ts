export const PrivDocument = `

この規約はBhaa利用規約、日本語原文です。本規約は原文に述べられている条項が適用され翻訳文は効力を持ちません。

この利用規約（以下，「本規約」といいます。）は，Bhaa Team（以下，「運営」といいます。）が提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
本規約に同意しない場合は直ちに本サービスの利用を停止し、本サービスを提供するソフトウェアプログラム等を削除してください。
...
- ユーザーは，本サービスの有料部分の対価として，運営が別途定め，本ウェブサイトに表示する利用料金を，運営が指定する方法により支払うものとします。
...
- 法令または公序良俗に違反する行為
- 犯罪行為に関連する行為
- 運営，本サービスの他のユーザー，または第三者のサーバーまたはネットワークの機能を破壊したり，妨害したりする行為
- 運営のサービスの運営を妨害するおそれのある行為
- 他のユーザーに関する個人情報等を収集または蓄積する行為
- 不正アクセスをし，またはこれを試みる行為
- 他のユーザーに成りすます行為
- 運営のサービスに関連して，反社会的勢力に対して直接または間接に利益を供与する行為
- 運営，本サービスの他のユーザーまたは第三者の知的財産権，肖像権，プライバシー，名誉その他の権利または利益を侵害する行為
- 以下の表現を含み，または含むと運営が判断する内容を本サービス上に投稿し，または送信する行為
    + 暴力的な表現
    + 露骨な性的表現
...
- 以下を目的とし，または目的とすると運営が判断する行為
    + 営業，宣伝，広告，勧誘，その他営利を目的とする行為（運営の認めたものを除きます。）
    + 性行為やわいせつな行為を目的とする行為
    + 面識のない異性との出会いや交際を目的とする行為
    + 他のユーザーに対する嫌がらせや誹謗中傷を目的とする行為
    + 運営，本サービスの他のユーザー，または第三者に不利益，損害または不快感を与えることを目的とする行為
...
- ユーザーが本サービスを利用して投稿ないしアップロードした文章，画像，映像等の著作権については，当該ユーザーその他既存の権利者に留保されるものとします。ただし，運営は，本サービスを利用して投稿ないしアップロードされた文章，画像，映像等について，本サービスの改良，品質の向上，または不備の是正等ならびに本サービスの周知宣伝等に必要な範囲で利用できるものとし，ユーザーは，この利用に関して，著作者人格権を行使しないものとします。
- 前項本文の定めるものを除き，本サービスおよび本サービスに関連する一切の情報についての著作権およびその他の知的財産権はすべて運営または運営にその利用を許諾した権利者に帰属し，ユーザーは無断で複製，譲渡，貸与，翻訳，改変，転載，公衆送信（送信可能化を含みます。），伝送，配布，出版，営業使用等をしてはならないものとします。

## 第8条（利用制限および登録抹消）

- 運営は，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，投稿データを削除し，ユーザーに対して本サービスの全部もしくは一部の利用を制限しまたはユーザーとしての登録を抹消することができるものとします。
    + 本規約のいずれかの条項に違反した場合
    + 登録事項に虚偽の事実があることが判明した場合
    + 決済手段として当該ユーザーが届け出たクレジットカードが利用停止となった場合
    + 料金等の支払債務の不履行があった場合
    + 運営からの連絡に対し，一定期間返答がない場合
    + 本サービスについて，最終の利用から一定期間利用がない場合
    + その他，運営が本サービスの利用を適当でないと判断した場合
